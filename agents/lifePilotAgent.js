  ...
  const tools = [
    {
      ...
      function: {
        ...
        description: 'Schedule a dentist appointment based on user preferences and availability',
        parameters: {
          type: 'object',
          properties: {
            preferredDate: {
              type: 'string',
              description: 'Preferred date for the appointment (e.g., "next Tuesday", "2025-11-25")'
            },
            preferredTime: {
              type: 'string',
            ...
            reason: {
              type: 'string',
              description: 'Reason for the appointment (e.g., "checkup", "cleaning", "toothache")'
            }
          },
          required: ['reason']
        }
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            reason: {
              type: 'string',
              description: 'Reason for dispute (e.g., "unauthorized charge", "never received item", "duplicate charge")'
            }
          },
  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are LifePilot, an AI life admin assistant. Help users with scheduling appointments, canceling subscriptions, and disputing charges. Use the provided functions to take action.'
        },
        {
          role: 'user',
          content: input
    ...
    switch (functionName) {
      case 'schedule_dentist_appointment':
        result = await scheduleDentist(functionArgs, openai);
        break;
    ...
    const summaryResponse = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'Summarize the result of the action in a friendly, conversational way.'
        },
        {
          role: 'user',
